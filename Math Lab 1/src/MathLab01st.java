...
{
    // 2D Perimeters
	public static <Perimeter> double squarePerimeter (double s)                      
	{ 	System.out.println("Pentagon Perimeter:               " + Geometry.pentagonPerimeter(5*4));
	System.out.println("Hexagon Perimeter:                " + Geometry.hexagonPerimeter(6*4));
	System.out.println("Octagon Perimeter:                " + Geometry.octagonPerimeter(8*4));
	System.out.println("Rectangle Perimeter:              " + Geometry.rectanglePerimeter(40,40));
	System.out.println("Circle Perimeter (circumference): " + Geometry.circumference(30));
	...
	private static String circumference(int i) {
	...
	private static String rectanglePerimeter(int i, int j) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	private static String octagonPerimeter(int i) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	private static String hexagonPerimeter(int i) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	private static String pentagonPerimeter(int i) {
		// TODO Auto-generated method stub
		return null;
	}
